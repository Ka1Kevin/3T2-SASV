...
import wedefense.models.MFA_Conformer as mfa_conformer
import wedefense.models.SKA_TDNN as ska_tdnn
...
def get_model(model_name: str):
    ...
    elif model_name.startswith('SKA_TDNN'):
        return getattr(ska_tdnn, model_name)
