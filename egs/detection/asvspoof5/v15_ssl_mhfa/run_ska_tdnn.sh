...
#SBATCH --job-name=SKA_TDNN-ASVspoof5 #job name
#SBATCH --gpus=1
...
data=data/hard_pair/ASVspoof5/ratio111/s2
# data=data/hard_pair/ASVspoof5/$trial_ratio # data folder

trial=/export/fs05/ktan17/dataset/ASVspoof5/train/${trial_name}.tsv
data_type="raw"  # shard/raw
config=conf/SKA_TDNN.yaml #wespeaker version
# config=conf/MHFA_wav2vec2.yaml
exp_dir=exp/ska_tdnn_asvspoof5
model_init=/export/fs05/ktan17/SASV2_Baseline/pretrained_weight/ska_tdnn.model
gpus="[0]"
checkpoint=
