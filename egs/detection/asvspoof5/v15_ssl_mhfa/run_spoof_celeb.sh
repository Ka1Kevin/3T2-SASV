...
#SBATCH --job-name=proto_ska #job name
...
#SBATCH --error=/export/fs05/ktan17/ssl/new_new_file/Spoofceleb.dev.%j.err
#SBATCH --output=/export/fs05/ktan17/ssl/new_new_file/Spoofceleb.dev.%j.out
# #SBATCH --array=0-3
...
exp_dir=exp/proto_ska_tdnn #1372053
